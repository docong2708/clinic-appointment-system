...
class CreateUserUseCaseTest {
    ...
    @Test
    void createsUserWithHashedPasswordAndDefaultPatientRole() {
        ...
        User created = useCase.execute(new CreateUserCommand("John@Example.com", "John Doe", "0123456789", "password123", null));
        ...
        assertThat(created.getStatus().name()).isEqualTo("PENDING_VERIFY");
    }
}
