...
@Service
public class MarkAppointmentPaymentAwaitingUseCase {

    private final AppointmentRepository appointmentRepository;
    private final AppointmentLogRepository appointmentLogRepository;

    public MarkAppointmentPaymentAwaitingUseCase(
    ...
    public AppointmentResult execute(MarkAppointmentPaymentCommand command) {
        ...
        appointment.markPaymentAwaiting(command.performedBy(), ActorRole.valueOf(command.performedByRole()));
