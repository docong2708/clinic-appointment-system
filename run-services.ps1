...
mvn compile -pl infra/config-server,infra/eureka-server,infra/api-gateway,services/doctor-service -DskipTests
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'CONFIG SERVER STARTING...'; mvn spring-boot:run -pl infra/config-server"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'EUREKA SERVER STARTING...'; mvn spring-boot:run -pl infra/eureka-server"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'API GATEWAY STARTING...'; mvn spring-boot:run -pl infra/api-gateway"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Write-Host 'DOCTOR SERVICE STARTING...'; mvn spring-boot:run -pl services/doctor-service"
